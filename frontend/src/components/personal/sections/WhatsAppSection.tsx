...
const WhatsAppSection: React.FC = () => {
  ...
  const messages: Message[] = [
    {
      id: '1',
      text: 'Здравствуйте, можно узнать стоимость доставки?',
      timestamp: '14:25',
      isSent: false
    },
    {
      id: '2',
      text: 'Здравствуйте! Доставка бесплатная при заказе от 5000 ₸',
      timestamp: '14:30',
      isSent: true
    }
  ];
      ...
      <div className="w-full bg-white border-b border-[#A7ABAA]/20">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-[#465357]">WhatsApp подключен</span>
          </div>
          <div className="flex space-x-8">
            <div>
              <div className="text-sm text-[#A7ABAA]">Конверсия в заказы</div>
              <div className="text-lg font-semibold text-[#465357]">35%</div>
            </div>
            <div>
              <div className="text-sm text-[#A7ABAA]">Среднее время ответа</div>
              <div className="text-lg font-semibold text-[#465357]">2.5 мин</div>
            </div>
            <div>
              <div className="text-sm text-[#A7ABAA]">Активные чаты</div>
              <div className="text-lg font-semibold text-[#465357]">23</div>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#A7ABAA]">
                        {chats.find(chat => chat.id === selectedChat)?.isOnline ? 'онлайн' : 'был(а) недавно'}
                      </div>
                    </div>
                  </div>
                </div>
